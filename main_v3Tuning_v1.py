...
model.compile(loss='binary_crossentropy',
            optimizer='adam', 
            metrics=['accuracy'])
model_backup = 'save_big_test\\ver3_Tuning_ver1-168-0.9286.hdf5'
...
# checkpoint = ModelCheckpoint('save_big_test\\ver3_Tuning_ver1-{epoch:02d}-{val_accuracy:.4f}.hdf5', monitor='val_accuracy', save_best_only=True)
